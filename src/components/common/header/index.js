...
const cuisines = [
  "American", "Asian", "Bakery", "BBQ", "Beverages", "Biryani", "Burger", "Cafe", "Continental", "Desserts", "European", "Fast Food", "Gujarati", "Ice Cream", "Italian", "Japanese", "Lebanese", "Mediterranean", "Mexican", "Mithai", "Mughlai", "North Indian", "Seafood", "South Indian", "Street Food", "Thai", "Vietnamese",
];
...
const Header = () => {
  ...
  const selectedCountryCode = useSelector((state) => state.restaurants.filters.countryCode);
  const [selectedCountry, setSelectedCountry] = useState(countries.find(country => country.code === selectedCountryCode)?.name || "");
  ...
  const handleRadiusChange = (e) => {
    ...
    if (latitude && longitude) {
      dispatch(fetchRestaurantsByLocation({ lat: latitude, lng: longitude, radius: selectedRadius }))
        .then((result) => console.log("Fetch Restaurants by Location Result:", result))
        .catch((error) => console.error("Error fetching restaurants by location:", error));
    }
  };
// ------- for far away results write something on the frontend
 ...
 // Get user's location when the component mounts
  ...
  const handleCountryChange = (e) => {
    ...
    const selectedCode = countries.find(country => country.name === selectedName).code;
    ...
    <div className="max-width header">
      ...
      <div className="header-right">
          ...
          <div className="location-wrapper">
            <div className="location-icon-name">
              ...
              <div className="slider-container">
                <label htmlFor="radius-slider">Radius: {selectedRadius} km</label>
                <input
                  id="radius-slider"
                  type="range"
                  min="10"
        ...
        <div className="profile-wrapper">
          ...
          />
          <span className="header-username">Lokesh</span>
